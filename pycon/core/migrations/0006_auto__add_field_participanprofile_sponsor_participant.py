...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ParticipanProfile.sponsor_participant'
        db.add_column('core_participanprofile', 'sponsor_participant', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ParticipanProfile.sponsor_participant'
        db.delete_column('core_participanprofile', 'sponsor_participant')
