...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ParticipanProfile.active'
        db.add_column('core_participanprofile', 'active', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'ParticipanProfile.verification_code'
        db.add_column('core_participanprofile', 'verification_code', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ParticipanProfile.active'
        db.delete_column('core_participanprofile', 'active')

        # Deleting field 'ParticipanProfile.verification_code'
        db.delete_column('core_participanprofile', 'verification_code')
