...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ParticipanProfile.kyivpy2'
        db.add_column('core_participanprofile', 'kyivpy2', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ParticipanProfile.kyivpy2'
        db.delete_column('core_participanprofile', 'kyivpy2')
    ...
    models = {
        ...
        'core.participanprofile': {
            ...
            'kyivpy2': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
