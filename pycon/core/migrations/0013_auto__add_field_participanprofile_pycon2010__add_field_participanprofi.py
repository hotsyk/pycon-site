...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ParticipanProfile.pycon2010'
        db.add_column('core_participanprofile', 'pycon2010', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'ParticipanProfile.agree'
        db.add_column('core_participanprofile', 'agree', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'ParticipanProfile.public'
        db.add_column('core_participanprofile', 'public', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ParticipanProfile.pycon2010'
        db.delete_column('core_participanprofile', 'pycon2010')

        # Deleting field 'ParticipanProfile.agree'
        db.delete_column('core_participanprofile', 'agree')

        # Deleting field 'ParticipanProfile.public'
        db.delete_column('core_participanprofile', 'public')
    ...
    models = {
        ...
        'core.participanprofile': {
            ...
            'kyivpy1': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'pycon2010': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
