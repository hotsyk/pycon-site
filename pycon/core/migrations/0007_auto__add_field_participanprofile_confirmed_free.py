...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ParticipanProfile.confirmed_free'
        db.add_column('core_participanprofile', 'confirmed_free', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ParticipanProfile.confirmed_free'
        db.delete_column('core_participanprofile', 'confirmed_free')
