...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'News.created'
        db.alter_column('core_news', 'created', self.gf('django.db.models.fields.DateTimeField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'News.created'
        db.alter_column('core_news', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
