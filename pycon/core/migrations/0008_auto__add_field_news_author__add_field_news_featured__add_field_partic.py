...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('core_news', 'author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)

        # Adding field 'News.featured'
        db.add_column('core_news', 'featured', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'ParticipanProfile.paid_bezgotivka'
        db.add_column('core_participanprofile', 'paid_bezgotivka', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'ParticipanProfile.paid_gotivka'
        db.add_column('core_participanprofile', 'paid_gotivka', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'ParticipanProfile.orgcomments'
        db.add_column('core_participanprofile', 'orgcomments', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'News.author'
        db.delete_column('core_news', 'author_id')

        # Deleting field 'News.featured'
        db.delete_column('core_news', 'featured')

        # Deleting field 'ParticipanProfile.paid_bezgotivka'
        db.delete_column('core_participanprofile', 'paid_bezgotivka')

        # Deleting field 'ParticipanProfile.paid_gotivka'
        db.delete_column('core_participanprofile', 'paid_gotivka')

        # Deleting field 'ParticipanProfile.orgcomments'
        db.delete_column('core_participanprofile', 'orgcomments')
