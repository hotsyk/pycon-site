...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Talks'
        db.create_table('core_talks', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('abstract', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('core', ['Talks'])

        # Adding M2M table for field authors on 'Talks'
        db.create_table('core_talks_authors', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('talks', models.ForeignKey(orm['core.talks'], null=False)),
            ('speaker', models.ForeignKey(orm['core.speaker'], null=False))
        ))
        db.create_unique('core_talks_authors', ['talks_id', 'speaker_id'])


    def backwards(self, orm):
        
        # Deleting model 'Talks'
        db.delete_table('core_talks')

        # Removing M2M table for field authors on 'Talks'
        db.delete_table('core_talks_authors')
