...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ParticipanProfile.kyivpy1'
        db.add_column('core_participanprofile', 'kyivpy1', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ParticipanProfile.kyivpy1'
        db.delete_column('core_participanprofile', 'kyivpy1')
